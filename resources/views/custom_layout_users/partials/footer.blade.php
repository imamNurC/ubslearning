<div class="px-6 w-full bg-gray-900">
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div class="text-center sm:text-left">
            <img src="{{ asset('image/Malaz_Solutions.png') }}" alt="logo" class="w-32 mx-auto sm:mx-0 bg-white mt-1 rounded-md">
            <p class="text-white mt-2">PT. PT Ceban</br>
