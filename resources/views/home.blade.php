...
<body class="font-poppins bg-gray-50">
        <div class="max-w-5xl h-[600px] mx-auto px-6 bg-gradient-to-r from-blue-900 via-blue-700 to-blue-500 py-10 rounded-b-3xl">
            ...
            <div class="flex justify-center mt-20">
                <input type="text" placeholder="Search" class="w-[900px] h-[45px] focus:bg-white bg-gray-200 border-2 rounded-2xl p-2 outline-none text-left leading-[30px]">
            </div>
        </div>

    <div class="container mx-auto px-6 py-16">
        <h2 class="text-center text-3xl font-bold mb-10 "> PILIHAN MATERI</h2>
