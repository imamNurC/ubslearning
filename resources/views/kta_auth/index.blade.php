...
<style>
    .login_img_section {
    background: linear-gradient(rgba(2,2,2,.7),rgba(0,0,0,.7)),url(https://www.qooper.io/hubfs/Blog%20images/informal%20mentoring.jpg) center center;
  }
  ...
  <div class="h-screen flex">
            ...
            <div class="flex w-full lg:w-1/2 justify-center items-center bg-white space-y-8">
              ...
              <form class="bg-white rounded-md shadow-2xl p-5" action="/login-mentor" method="POST">
                @csrf
                @if (session('success'))
                ...
                @endif
                <h1 class="text-gray-800 font-bold text-2xl mb-1">Hello Mentor!</h1>
                ...
                <div class="flex justify-between mt-4">
                  ...
                  <a href="kta/register" class="text-sm ml-2 hover:text-blue-500 cursor-pointer hover:-translate-y-1 duration-500 transition-all">Don't have an account yet?</a>
                </div>
