@extends('kta_layout.bases.login_layout')
@section('content')
    <form action="{{ route('kta.register') }}" method="POST" enctype="multipart/form-data">
    @csrf
          ...
          <div class="md:flex w-full">
              ...
              <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                  <div class="text-center mb-10">
                      <h1 class="font-bold text-3xl text-gray-900">REGISTER KTA ACT</h1>
                      <p>Enter your information to register</p>
                  </div>
                 

                <div class="w-full px-3 mb-5"> 
                    <label for="nama_kta" class="text-xs font-semibold px-1">Nama KTA</label>
                    <div class="flex">
                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <i class="mdi mdi-account text-gray-400 text-lg"></i>
                        </div>
                        <input type="text" id="nama_kta" name="nama_kta" required class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('nama_kta') border-red-500 @enderror" placeholder="Masukkan nama anda"/>
                    </div>
                </div>
                <div class="w-full px-3 mb-5"> 
                    <label for="foto_kta" class="text-xs font-semibold px-1">Foto KTA</label>
                    <div class="flex items-center">
                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <i class="mdi mdi-image-outline text-gray-400 text-lg"></i>
                        </div>
                        <input type="file" id="foto_kta" name="foto_kta" accept=".png,.jpg,.jpeg" required class="hidden" />
                        <button type="button" onclick="document.getElementById('foto_kta').click();" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 text-left outline-none focus:border-indigo-500 @error('foto_kta') border-red-500 @enderror">
                            <span class="text-gray-700">Choose File</span>
                        </button>
                        <span id="file-name" class="ml-3 text-gray-700"></span> <!-- Placeholder for file name -->
                    </div>
                </div>
                ...
                <div class="w-full px-3 mb-5"> 
                    <label for="nickname_kta" class="text-xs font-semibold px-1">Nickname KTA</label>
                    <div class="flex">
                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <i class="mdi mdi-account-outline text-gray-400 text-lg"></i>
                        </div>
                        <input type="text" id="nickname_kta" name="nickname_kta" required class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('nickname_kta') border-red-500 @enderror" placeholder="Masukkan nickname anda"/>
                    </div>
                </div>
                
                <div class="w-full px-3 mb-5"> 
                    <label for="nohp_kta" class="text-xs font-semibold px-1">No HP KTA</label>
                    <div class="flex">
                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <i class="mdi mdi-phone-outline text-gray-400 text-lg"></i>
                        </div>
                        <input type="text" id="nohp_kta" name="nohp_kta" required class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('nohp_kta') border-red-500 @enderror" placeholder="Masukkan no HP anda"/>
                    </div>
                </div>
                
                <div class="w-full px-3 mb-5"> 
                    <label for="email" class="text-xs font-semibold px-1">Email KTA</label>
                    <div class="flex">
                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <i class="mdi mdi-email-outline text-gray-400 text-lg"></i>
                        </div>
                        <input type="email" id="email" name="email" required class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('email') border-red-500 @enderror" placeholder="Masukkan email anda"/>
                    </div>
                </div>
                
                <div class="w-full px-3 mb-5"> 
                    <label for="jabatan_kta" class="text-xs font-semibold px-1">Jabatan KTA</label>
                    <div class="flex">
                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <i class="mdi mdi-briefcase-outline text-gray-400 text-lg"></i>
                        </div>
                        <input type="text" id="jabatan_kta" name="jabatan_kta" required class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('jabatan_kta') border-red-500 @enderror" placeholder="Masukkan jabatan anda"/>
                    </div>
                </div>
                
                <div class="w-full px-3 mb-5"> 
                    <label for="status_kta" class="text-xs font-semibold px-1">Status KTA</label>
                    <div class="flex">
                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <i class="mdi mdi-checkbox-marked-outline text-gray-400 text-lg"></i>
                        </div>
                        <select id="status_kta" name="status_kta" required class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('status_kta') border-red-500 @enderror">
                ...
                <div class="w-full px-3 mb-5"> 
                    <label for="bergabung_kta" class="text-xs font-semibold px-1">Bergabung KTA</label>
                    <div class="flex">
                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <i class="mdi mdi-calendar-text-outline text-gray-400 text-lg"></i>
                        </div>
                        <input type="date" id="bergabung_kta" name="bergabung_kta" required class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('bergabung_kta') border-red-500 @enderror"/>
                    </div>
                </div>
                
                <div class="w-full px-3 mb-5"> 
                    <label for="kadaluarsa_kta" class="text-xs font-semibold px-1">Kadaluarsa KTA</label>
                    <div class="flex">
                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <i class="mdi mdi-calendar-remove-outline text-gray-400 text-lg"></i>
                        </div>
                        <input type="date" id="kadaluarsa_kta" name="kadaluarsa_kta" required class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('kadaluarsa_kta') border-red-500 @enderror"/>
                    </div>
                </div>
                
                <div class="w-full px-3 mb-5"> 
                    <label for="sunting_kta" class="text-xs font-semibold px-1">Sunting KTA</label>
                    <div class="flex">
                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <i class="mdi mdi-pencil-outline text-gray-400 text-lg"></i>
                        </div>
                        <input type="text" id="sunting_kta" name="sunting_kta" required class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('sunting_kta') border-red-500 @enderror" placeholder="Masukkan informasi tambahan"/>
                    </div>
                </div>
                ...
                <div class="w-full px-3 mb-5">
                    ...
                    <div class="flex relative">
                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <i class="mdi mdi-eye-outline text-gray-400 text-lg"></i>
                        </div>
                        <input type="password" id="password" name="password" required class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('password') border-red-500 @enderror" placeholder="Masukkan password"/>
                    </div>
                ...
                <button type="submit" class="bg-indigo-500 text-white rounded px-4 py-2">Register</button>
              </div>
          </div>
      </div>
    </div>
...
<script>
    document.getElementById('foto_kta').addEventListener('change', function() {
