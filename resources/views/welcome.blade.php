	...
	<nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
		<div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
			<a href="#" class="flex items-center">
				<img src="http://raw.githubusercontent.com/imamNurC/ubslearning/refs/heads/imam_dev/public/image/Logo.png" class="h-6 mr-3 sm:h-9" alt="Landwind Logo" />
				<span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Malaz Solutions</span>
			</a>
			<div class="flex items-center lg:order-2">
				<div class="hidden mt-2 mr-4 sm:inline-block">
					<a class="github-button" href="#" target="_blank" data-size="large"
				...
				<a href="mailto:imamnc.developer@gmail.com" 
					class="ml-4 text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-orange-400 dark:hover:bg-orange-500 focus:outline-none dark:focus:ring-orange-600">Mentor?</a>
...
<section class="bg-white dark:bg-gray-900">
	<div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
		...
		<div class="hidden lg:mt-8 lg:col-span-6 lg:flex">
			<img src="https://raw.githubusercontent.com/imamNurC/ubslearning/refs/heads/imam_dev/public/image/Logo.png" alt="hero image">
		</div>
		<div class="mr-auto place-self-center lg:col-span-6">
			<h4 class="max-w-2xl mb-4 text-4xl font-variation-settings leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">
				Aset Solusi Digital anda<br>produk konten video 
			</h4>
				<p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">layanan video pembelejaran yang dapat diakses dimana saja dan kapan saja
				</p>
					<a
						href="#" target="_blank" class="hover:underline">Open Source proyek</a> Untuk siapapun yang ingin berkontribusi pada sistem kami  
						{{-- <a href="#/"
						class="hover:underline" target="_blank">Flowbite Library</a> 
						and the <a href="https://flowbite.com/blocks/" target="_blank"
	...
	<div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
		<div class="md:w-2/3 lg:w-1/2">
		  ...
		  <h2 class="my-8 text-2xl font-bold text-gray-700 dark:text-white md:text-4xl">
			Sebuah Solusi digital edukasi
			dengan pendekatan Teknologi AI
		  </h2>
	...
	<div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
		...
		<div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
			<div class="text-gray-500 sm:text-lg dark:text-gray-400">
				<h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white"> Layanan kelas belajar, </h2>
				<p class="mb-8 font-light lg:text-xl">Kami membuka lowongan sebagai mentor. Jika anda seorang yang memiliki keahlian khusus. anda bisa membuka kelas untuk menanamkan aset digital anda pada sistem ini</p>
			...
			<img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="https://demo.themesberg.com/landwind/images/feature-1.png" alt="dashboard feature image">
		</div>

			<div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
				<img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="https://demo.themesberg.com/landwind/images/feature-2.png" alt="feature image 2">
				<div class="text-gray-500 sm:text-lg dark:text-gray-400">
