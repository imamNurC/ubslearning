    ...
    <section class="w-full overflow-hidden mb-80">
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="px-4 py-5 sm:px-6 flex items-center">
                <!-- Foto Profil -->
                <img src="{{ Storage::url($customer->image_path) }}" alt="Profile Picture" class="h-12 w-12 rounded-full mr-4">
            ...
            <div class="border-t border-gray-200 px-4 py-5 sm:p-0 mb-10">
                <dl class="sm:divide-y sm:divide-gray-200">
                    ...
                    <div class="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <div class="sm:col-span-3 mt-2 text-right">
            ...
            <form action="{{ route('profile.update', $customer->username) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="col-span-2">
                        ...
                        <img id="profile-preview" src="#" alt="Profile Picture" class="rounded-full w-24 h-24 mt-4" style="display: none;">
                    </div>
                </div>
